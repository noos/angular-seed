...
describe('EventListController', function(){
    ...
    it("should set the scope event to the result of eventData.getAllEvents", function(){
        var mockEvents = {};
    ...
    it("should navigate to correct url when navigateToDetails is called", function(){
